...
#ifndef OPENGL_ENVIRONMENT_TEST_TEXTUREWRAP_H
#define OPENGL_ENVIRONMENT_TEST_TEXTUREWRAP_H
...
public:
    static int another_texture_wrap();
...
#endif //OPENGL_ENVIRONMENT_TEST_TEXTUREWRAP_H
